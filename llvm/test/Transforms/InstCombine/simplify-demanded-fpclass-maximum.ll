...
; -> qnan
define nofpclass(ninf nnorm nsub nzero) float @ret_known_positive_or_nan__maximum__negative_or_nan___negative_or_nan() {
...
;
  ...
  %result = call float @llvm.maximum.f32(float %must.be.negative.or.nan0, float %must.be.negative.or.nan1)
  ret float %result
}

; -> qnan
define nofpclass(pinf pnorm psub pzero) float @ret_known_negative_or_nan__maximum__positive_or_nan___positive_or_nan() {
...
;
  ...
  %result = call float @llvm.maximum.f32(float %must.be.positive.or.nan0, float %must.be.positive.or.nan1)
  ret float %result
}

define nofpclass(snan) float @known_positive_or_nan__maximum__known_negative_or_nan() {
...
;
  ...
  %result = call float @llvm.maximum.f32(float %must.be.positive.or.nan, float %must.be.negative.or.nan)
  ret float %result
}

define nofpclass(snan) float @known_negative_or_nan__maximum__known_positive_or_nan() {
...
;
  %must.be.negative.or.nan = call float @returns_negative_or_nan()
  %must.be.positive.or.nan = call float @returns_positive_or_nan()
  %result = call float @llvm.maximum.f32(float %must.be.negative.or.nan, float %must.be.positive.or.nan)
  ret float %result
}
...
;
  ...
  %result = call float @llvm.maximum.f32(float %must.be.positive.or.nan, float %must.be.negative)
  ret float %result
}
...
;
  %must.be.negative = call float @returns_negative()
  %must.be.positive.or.nan = call float @returns_positive_or_nan()
  %result = call float @llvm.maximum.f32(float %must.be.negative, float %must.be.positive.or.nan)
  ret float %result
}

define nofpclass(ninf nnorm nsub nzero) float @ret_always_positive_or_nan__select_always_negative_or_unknown__maximum__unknown(i1 %cond, float %unknown0, float %unknown1) {
; CHECK-LABEL: define nofpclass(ninf nzero nsub nnorm) float @ret_always_positive_or_nan__select_always_negative_or_unknown__maximum__unknown(
...
define nofpclass(ninf nnorm nsub nzero) float @ret_always_positive_or_nan__unknown__maximum__select_always_negative_or_unknown(i1 %cond, float %unknown0, float %unknown1) {
; CHECK-LABEL: define nofpclass(ninf nzero nsub nnorm) float @ret_always_positive_or_nan__unknown__maximum__select_always_negative_or_unknown(
; CHECK-SAME: i1 [[COND:%.*]], float [[UNKNOWN0:%.*]], float [[UNKNOWN1:%.*]]) {
; CHECK-NEXT:    [[ALWAYS_NEGATIVE:%.*]] = call float @returns_negative()
...
define nofpclass(ninf nnorm nsub nzero nan) float @ret_always_positive__select_always_negative_or_unknown__maximum__unknown(i1 %cond, float %unknown0, float %unknown1) {
; CHECK-LABEL: define nofpclass(nan ninf nzero nsub nnorm) float @ret_always_positive__select_always_negative_or_unknown__maximum__unknown(
; CHECK-SAME: i1 [[COND:%.*]], float [[UNKNOWN0:%.*]], float [[UNKNOWN1:%.*]]) {
; CHECK-NEXT:    [[ALWAYS_NEGATIVE:%.*]] = call float @returns_negative()
; CHECK-NEXT:    [[SELECT_LHS:%.*]] = select i1 [[COND]], float [[ALWAYS_NEGATIVE]], float [[UNKNOWN0]]
...
define nofpclass(ninf nnorm nsub nzero nan) float @ret_always_positive__unknown__maximum__select_always_negative_or_unknown(i1 %cond, float %unknown0, float %unknown1) {
; CHECK-LABEL: define nofpclass(nan ninf nzero nsub nnorm) float @ret_always_positive__unknown__maximum__select_always_negative_or_unknown(
; CHECK-SAME: i1 [[COND:%.*]], float [[UNKNOWN0:%.*]], float [[UNKNOWN1:%.*]]) {
; CHECK-NEXT:    [[ALWAYS_NEGATIVE:%.*]] = call float @returns_negative()
; CHECK-NEXT:    [[SELECT_RHS:%.*]] = select i1 [[COND]], float [[ALWAYS_NEGATIVE]], float [[UNKNOWN0]]
...
;
  ...
  %result = call float @llvm.maximum.f32(float %must.be.negative.or.zero, float %must.be.positive.or.zero)
  ret float %result
}
...
;
  %must.be.negative.or.zero = call float @returns_positive_or_zero()
  %must.be.positive.or.zero = call float @returns_negative_or_zero()
  %result = call float @llvm.maximum.f32(float %must.be.positive.or.zero, float %must.be.negative.or.zero)
  ret float %result
}
...
; CHECK-NEXT:    [[RESULT:%.*]] = call float @llvm.maximum.f32(float [[NOT_NZERO]], float [[NOT_PZERO]])
; CHECK-NEXT:    ret float [[RESULT]]
;
  %result = call float @llvm.maximum.f32(float %not.nzero, float %not.pzero)
  ret float %result
}
...
define nofpclass(snan) float @not_nan__maximum__unknown(float nofpclass(nan) %x, float %y) {
; CHECK-LABEL: define nofpclass(snan) float @not_nan__maximum__unknown(
...
define nofpclass(snan) float @unknown__maximum__not_nan(float %x, float nofpclass(nan) %y) {
; CHECK-LABEL: define nofpclass(snan) float @unknown__maximum__not_nan(
...
define nofpclass(snan) float @not_snan__maximum__not_snan(float nofpclass(snan) %x, float nofpclass(snan) %y) {
; CHECK-LABEL: define nofpclass(snan) float @not_snan__maximum__not_snan(
...
define nofpclass(inf) float @ret_noinf__not_qnan__maximum__not_qnan(float nofpclass(qnan) %x, float nofpclass(qnan) %y) {
; CHECK-LABEL: define nofpclass(inf) float @ret_noinf__not_qnan__maximum__not_qnan(
...
define nofpclass(snan) float @known_positive__maximum__only_zero() {
...
;
  ...
  %result = call float @llvm.maximum.f32(float %known.positive, float %known.zero)
  ret float %result
}

define nofpclass(snan) float @only_zero__maximum__known_positive() {
...
;
  %known.zero = call float @returns_zero()
  %known.positive = call float @returns_positive()
  %result = call float @llvm.maximum.f32(float %known.zero, float %known.positive)
  ret float %result
}

define nofpclass(snan) float @known_positive__maximum__only_zero_or_nan() {
; CHECK-LABEL: define nofpclass(snan) float @known_positive__maximum__only_zero_or_nan() {
; CHECK-NEXT:    [[KNOWN_POSITIVE:%.*]] = call float @returns_positive()
; CHECK-NEXT:    [[KNOWN_ZERO_OR_NAN:%.*]] = call float @returns_zero_or_nan()
; CHECK-NEXT:    [[RESULT:%.*]] = call float @llvm.maximum.f32(float [[KNOWN_POSITIVE]], float [[KNOWN_ZERO_OR_NAN]])
; CHECK-NEXT:    ret float [[RESULT]]
;
  %known.positive = call float @returns_positive()
  %known.zero.or.nan = call float @returns_zero_or_nan()
  %result = call float @llvm.maximum.f32(float %known.positive, float %known.zero.or.nan)
  ret float %result
}

define nofpclass(snan) float @only_zero_or_nan__maximum__known_positive() {
; CHECK-LABEL: define nofpclass(snan) float @only_zero_or_nan__maximum__known_positive() {
; CHECK-NEXT:    [[KNOWN_ZERO_OR_NAN:%.*]] = call float @returns_zero_or_nan()
; CHECK-NEXT:    [[KNOWN_POSITIVE:%.*]] = call float @returns_positive()
; CHECK-NEXT:    [[RESULT:%.*]] = call float @llvm.maximum.f32(float [[KNOWN_ZERO_OR_NAN]], float [[KNOWN_POSITIVE]])
; CHECK-NEXT:    ret float [[RESULT]]
;
  %known.zero.or.nan = call float @returns_zero_or_nan()
  %known.positive = call float @returns_positive()
  %result = call float @llvm.maximum.f32(float %known.zero.or.nan, float %known.positive)
  ret float %result
}

define nofpclass(snan) float @known_positive_or_nan__maximum__only_zero() {
...
;
  ...
  %known.zero = call float @returns_zero()
  %result = call float @llvm.maximum.f32(float %known.positive.or.nan, float %known.zero)
  ret float %result
}

define nofpclass(snan) float @only_zero__maximum__known_positive_or_nan() {
...
;
  %known.zero = call float @returns_zero()
  %known.positive.or.nan = call float @returns_positive_or_nan()
  %result = call float @llvm.maximum.f32(float %known.zero, float %known.positive.or.nan)
  ret float %result
}

define nofpclass(snan) float @known_positive__maximum__only_nzero() {
...
;
  ...
  %result = call float @llvm.maximum.f32(float %known.positive, float %known.nzero)
  ret float %result
}

define nofpclass(snan) float @only_nzero__maximum__known_positive() {
...
;
  %known.nzero = call float @returns_nzero()
  %known.positive = call float @returns_positive()
  %result = call float @llvm.maximum.f32(float %known.nzero, float %known.positive)
  ret float %result
}

define nofpclass(snan) float @known_positive__maximum__only_pzero() {
...
;
  ...
  %result = call float @llvm.maximum.f32(float %known.positive, float %known.pzero)
  ret float %result
}

define nofpclass(snan) float @only_pzero__maximum__known_positive() {
...
;
  %known.pzero = call float @returns_pzero()
  %known.positive = call float @returns_positive()
  %result = call float @llvm.maximum.f32(float %known.pzero, float %known.positive)
  ret float %result
}

define nofpclass(snan) float @known_negative__maximum__only_zero_or_nan() {
...
;
  ...
  %known.zero.or.nan = call float @returns_zero_or_nan()
  %result = call float @llvm.maximum.f32(float %known.negative, float %known.zero.or.nan)
  ret float %result
}

define nofpclass(snan) float @only_zero_or_nan__maximum__known_negative() {
...
;
  %known.zero.or.nan = call float @returns_zero_or_nan()
  %known.negative = call float @returns_negative()
  %result = call float @llvm.maximum.f32(float %known.zero.or.nan, float %known.negative)
  ret float %result
}

define nofpclass(snan) float @known_negative_or_nan__maximum__only_zero() {
; CHECK-LABEL: define nofpclass(snan) float @known_negative_or_nan__maximum__only_zero() {
; CHECK-NEXT:    [[KNOWN_NEGATIVE_OR_NAN:%.*]] = call float @returns_negative_or_nan()
; CHECK-NEXT:    [[KNOWN_ZERO:%.*]] = call float @returns_zero()
; CHECK-NEXT:    [[RESULT:%.*]] = call float @llvm.maximum.f32(float [[KNOWN_NEGATIVE_OR_NAN]], float [[KNOWN_ZERO]])
; CHECK-NEXT:    ret float [[RESULT]]
;
  %known.negative.or.nan = call float @returns_negative_or_nan()
  %known.zero = call float @returns_zero()
  %result = call float @llvm.maximum.f32(float %known.negative.or.nan, float %known.zero)
  ret float %result
}

define nofpclass(snan) float @only_zero__maximum__known_negative_or_nan() {
; CHECK-LABEL: define nofpclass(snan) float @only_zero__maximum__known_negative_or_nan() {
; CHECK-NEXT:    [[KNOWN_ZERO:%.*]] = call float @returns_zero()
; CHECK-NEXT:    [[KNOWN_NEGATIVE_OR_NAN:%.*]] = call float @returns_negative_or_nan()
; CHECK-NEXT:    [[RESULT:%.*]] = call float @llvm.maximum.f32(float [[KNOWN_ZERO]], float [[KNOWN_NEGATIVE_OR_NAN]])
; CHECK-NEXT:    ret float [[RESULT]]
;
  %known.zero = call float @returns_zero()
  %known.negative.or.nan = call float @returns_negative_or_nan()
  %result = call float @llvm.maximum.f32(float %known.zero, float %known.negative.or.nan)
  ret float %result
}

define nofpclass(snan) float @known_negative__maximum__only_nzero() {
; CHECK-LABEL: define nofpclass(snan) float @known_negative__maximum__only_nzero() {
; CHECK-NEXT:    [[KNOWN_NEGATIVE:%.*]] = call float @returns_negative()
; CHECK-NEXT:    [[KNOWN_NZERO:%.*]] = call float @returns_nzero()
; CHECK-NEXT:    ret float -0.000000e+00
;
  %known.negative = call float @returns_negative()
  %known.nzero = call float @returns_nzero()
  %result = call float @llvm.maximum.f32(float %known.negative, float %known.nzero)
  ret float %result
}

define nofpclass(snan) float @only_nzero__maximum__known_negative() {
; CHECK-LABEL: define nofpclass(snan) float @only_nzero__maximum__known_negative() {
; CHECK-NEXT:    [[KNOWN_NZERO:%.*]] = call float @returns_nzero()
; CHECK-NEXT:    [[KNOWN_NEGATIVE:%.*]] = call float @returns_negative()
; CHECK-NEXT:    ret float -0.000000e+00
;
  %known.nzero = call float @returns_nzero()
  %known.negative = call float @returns_negative()
  %result = call float @llvm.maximum.f32(float %known.nzero, float %known.negative)
  ret float %result
}

define nofpclass(snan) float @known_negative__maximum__only_nzero_or_nan() {
...
;
  ...
  %result = call float @llvm.maximum.f32(float %known.negative, float %known.nzero.or.nan)
  ret float %result
}

define nofpclass(snan) float @only_nzero_or_nan__maximum__known_negative() {
...
;
  %known.nzero.or.nan = call float @returns_nzero_or_nan()
  %known.negative = call float @returns_negative()
  %result = call float @llvm.maximum.f32(float %known.nzero.or.nan, float %known.negative)
  ret float %result
}

define nofpclass(snan) float @known_negative__maximum__only_pzero() {
; CHECK-LABEL: define nofpclass(snan) float @known_negative__maximum__only_pzero() {
; CHECK-NEXT:    [[KNOWN_NEGATIVE:%.*]] = call float @returns_negative()
; CHECK-NEXT:    [[KNOWN_PZERO:%.*]] = call float @returns_pzero()
; CHECK-NEXT:    ret float 0.000000e+00
;
  %known.negative = call float @returns_negative()
  %known.pzero = call float @returns_pzero()
  %result = call float @llvm.maximum.f32(float %known.negative, float %known.pzero)
  ret float %result
}

define nofpclass(snan) float @only_pzero__maximum__known_negative() {
; CHECK-LABEL: define nofpclass(snan) float @only_pzero__maximum__known_negative() {
; CHECK-NEXT:    [[KNOWN_PZERO:%.*]] = call float @returns_pzero()
; CHECK-NEXT:    [[KNOWN_NEGATIVE:%.*]] = call float @returns_negative()
; CHECK-NEXT:    ret float 0.000000e+00
;
  %known.pzero = call float @returns_pzero()
  %known.negative = call float @returns_negative()
  %result = call float @llvm.maximum.f32(float %known.pzero, float %known.negative)
  ret float %result
}

define nofpclass(snan) float @known_negative__maximum__only_pzero_or_nan() {
...
;
  ...
  %result = call float @llvm.maximum.f32(float %known.negative, float %known.pzero.or.nan)
  ret float %result
}

define nofpclass(snan) float @only_pzero_or_nan__maximum__known_negative() {
...
;
  %known.pzero.or.nan = call float @returns_pzero_or_nan()
  %known.negative = call float @returns_negative()
  %result = call float @llvm.maximum.f32(float %known.pzero.or.nan, float %known.negative)
  ret float %result
}

define nofpclass(pinf pnorm psub pzero) float @ret_always_negative_or_nan__unknown__maximum__select_always_negative_or_unknown(i1 %cond, float %unknown0, float %unknown1) {
; CHECK-LABEL: define nofpclass(pinf pzero psub pnorm) float @ret_always_negative_or_nan__unknown__maximum__select_always_negative_or_unknown(
; CHECK-SAME: i1 [[COND:%.*]], float [[UNKNOWN0:%.*]], float [[UNKNOWN1:%.*]]) {
; CHECK-NEXT:    [[ALWAYS_NEGATIVE:%.*]] = call float @returns_negative()
; CHECK-NEXT:    [[SELECT_RHS:%.*]] = select i1 [[COND]], float [[ALWAYS_NEGATIVE]], float [[UNKNOWN0]]
; CHECK-NEXT:    [[RESULT:%.*]] = call float @llvm.maximum.f32(float [[UNKNOWN1]], float [[SELECT_RHS]])
...
define nofpclass(pinf pnorm psub pzero) float @ret_always_negative_or_nan__unknown__maximum__select_always_positive_or_unknown(i1 %cond, float %unknown0, float %unknown1) {
; CHECK-LABEL: define nofpclass(pinf pzero psub pnorm) float @ret_always_negative_or_nan__unknown__maximum__select_always_positive_or_unknown(
; CHECK-SAME: i1 [[COND:%.*]], float [[UNKNOWN0:%.*]], float [[UNKNOWN1:%.*]]) {
...
define nofpclass(pinf pnorm psub) float @ret_always_positive_nonzero__maximum__not_zero_select_positive_or_unknown(i1 %cond, float %unknown, float nofpclass(zero) %not.zero) {
; CHECK-LABEL: define nofpclass(pinf psub pnorm) float @ret_always_positive_nonzero__maximum__not_zero_select_positive_or_unknown(
...
define nofpclass(pinf pnorm psub) float @ret_always_positive_nonzero__maximum__not_zero_select_negative_or_unknown(i1 %cond, float %unknown, float nofpclass(zero) %not.zero) {
; CHECK-LABEL: define nofpclass(pinf psub pnorm) float @ret_always_positive_nonzero__maximum__not_zero_select_negative_or_unknown(
; CHECK-SAME: i1 [[COND:%.*]], float [[UNKNOWN:%.*]], float nofpclass(zero) [[NOT_ZERO:%.*]]) {
; CHECK-NEXT:    [[ALWAYS_NEGATIVE:%.*]] = call float @returns_negative()
...
define nofpclass(snan) float @known_positive__maximum__only_pzero_or_nan() {
...
;
  %known.positive = call float @returns_positive()
  %known.pzero.or.nan = call float @returns_pzero_or_nan()
  %result = call float @llvm.maximum.f32(float %known.positive, float %known.pzero.or.nan)
  ret float %result
}

define nofpclass(nan) float @ret_nonan__known_negative_or_nan__maximum__known_positive_or_nan() {
...
define nofpclass(nan) float @ret_nonan__known_positive_or_nan__maximum__known_negative_or_nan() {
...
define nofpclass(nan) float @ret_nonan__select_nan_or_unknown__maximum__unknown(i1 %cond, float %unknown0, float %unknown1) {
...
define nofpclass(nan) float @ret_nonan__unknown__maximum__select_nan_or_unknown(i1 %cond, float %unknown0, float %unknown1) {
...
define nofpclass(ninf nnorm nsub nzero) float @result_known_positive_or_nan__known_positive__maximum__not_nan(float nofpclass(ninf nnorm nsub nzero) %lhs, float nofpclass(nan) %rhs) {
; CHECK-LABEL: define nofpclass(ninf nzero nsub nnorm) float @result_known_positive_or_nan__known_positive__maximum__not_nan(
; CHECK-SAME: float nofpclass(ninf nzero nsub nnorm) [[LHS:%.*]], float nofpclass(nan) [[RHS:%.*]]) {
; CHECK-NEXT:    [[RESULT:%.*]] = call float @llvm.maximum.f32(float [[LHS]], float [[RHS]])
; CHECK-NEXT:    ret float [[RESULT]]
;
...
define nofpclass(ninf nnorm nsub nzero) float @result_known_positive_or_nan__not_nan__maximum__known_positive(float nofpclass(nan) %lhs, float nofpclass(ninf nnorm nsub nzero) %rhs) {
; CHECK-LABEL: define nofpclass(ninf nzero nsub nnorm) float @result_known_positive_or_nan__not_nan__maximum__known_positive(
...
define nofpclass(snan) float @known_always_positive__maximum__known_always_negative_or_nan() {
; CHECK-LABEL: define nofpclass(snan) float @known_always_positive__maximum__known_always_negative_or_nan() {
; CHECK-NEXT:    [[KNOWN_POSITIVE:%.*]] = call float @returns_positive()
; CHECK-NEXT:    [[KNOWN_NEGATIVE_OR_NAN:%.*]] = call float @returns_negative_or_nan()
; CHECK-NEXT:    [[RESULT:%.*]] = call float @llvm.maximum.f32(float [[KNOWN_POSITIVE]], float [[KNOWN_NEGATIVE_OR_NAN]])
; CHECK-NEXT:    ret float [[RESULT]]
;
  %known.positive = call float @returns_positive()
  %known.negative.or.nan = call float @returns_negative_or_nan()
  %result = call float @llvm.maximum.f32(float %known.positive, float %known.negative.or.nan)
  ret float %result
}

define nofpclass(snan) float @known_always_negative_or_nan__maximum__known_always_positive() {
; CHECK-LABEL: define nofpclass(snan) float @known_always_negative_or_nan__maximum__known_always_positive() {
; CHECK-NEXT:    [[KNOWN_NEGATIVE_OR_NAN:%.*]] = call float @returns_negative_or_nan()
; CHECK-NEXT:    [[KNOWN_POSITIVE:%.*]] = call float @returns_positive()
; CHECK-NEXT:    [[RESULT:%.*]] = call float @llvm.maximum.f32(float [[KNOWN_NEGATIVE_OR_NAN]], float [[KNOWN_POSITIVE]])
; CHECK-NEXT:    ret float [[RESULT]]
;
  %known.negative.or.nan = call float @returns_negative_or_nan()
  %known.positive = call float @returns_positive()
  %result = call float @llvm.maximum.f32(float %known.negative.or.nan, float %known.positive)
  ret float %result
}

define nofpclass(snan) float @known_always_positive_or_nan__maximum__known_always_negative_or_nan() {
; CHECK-LABEL: define nofpclass(snan) float @known_always_positive_or_nan__maximum__known_always_negative_or_nan() {
; CHECK-NEXT:    [[KNOWN_POSITIVE_OR_NAN:%.*]] = call float @returns_positive_or_nan()
; CHECK-NEXT:    [[KNOWN_NEGATIVE_OR_NAN:%.*]] = call float @returns_negative_or_nan()
...
;
  %known.positive.or.nan = call float @returns_positive_or_nan()
  %known.negative.or.nan = call float @returns_negative_or_nan()
  %result = call float @llvm.maximum.f32(float %known.positive.or.nan, float %known.negative.or.nan)
  ret float %result
}

define nofpclass(snan) float @known_always_negative_or_nan__maximum__known_always_positive_or_nan() {
; CHECK-LABEL: define nofpclass(snan) float @known_always_negative_or_nan__maximum__known_always_positive_or_nan() {
; CHECK-NEXT:    [[KNOWN_NEGATIVE_OR_NAN:%.*]] = call float @returns_negative_or_nan()
; CHECK-NEXT:    [[KNOWN_POSITIVE_OR_NAN:%.*]] = call float @returns_positive_or_nan()
...
;
  %known.negative.or.nan = call float @returns_negative_or_nan()
  %known.positive.or.nan = call float @returns_positive_or_nan()
  %result = call float @llvm.maximum.f32(float %known.negative.or.nan, float %known.positive.or.nan)
  ret float %result
}

define nofpclass(nan) float @ret_no_nan__known_always_positive_or_nan__maximum__known_always_negative_or_nan() {
...
define nofpclass(nan) float @ret_no_nan__known_always_negative_or_nan__maximum__known_always_positive_or_nan() {
...
define nofpclass(snan) float @pinf__maximum__unknown(float %unknown) {
...
;
  ...
  %result = call float @llvm.maximum.f32(float %pinf, float %unknown)
  ret float %result
}

define nofpclass(snan) float @unknown__maximum__pinf(float %unknown) {
...
;
  %pinf = call float @returns_pinf()
  %result = call float @llvm.maximum.f32(float %unknown, float %pinf)
  ret float %result
}

define nofpclass(snan) float @pinf_or_nan__maximum__unknown(float %unknown) {
; CHECK-LABEL: define nofpclass(snan) float @pinf_or_nan__maximum__unknown(
; CHECK-SAME: float [[UNKNOWN:%.*]]) {
; CHECK-NEXT:    [[PINF_OR_NAN:%.*]] = call float @returns_pinf_or_nan()
; CHECK-NEXT:    [[RESULT:%.*]] = call nsz float @llvm.maximum.f32(float [[PINF_OR_NAN]], float [[UNKNOWN]])
; CHECK-NEXT:    ret float [[RESULT]]
;
  %pinf.or.nan = call float @returns_pinf_or_nan()
  %result = call float @llvm.maximum.f32(float %pinf.or.nan, float %unknown)
  ret float %result
}

define nofpclass(snan) float @unknown__maximum__pinf_or_nan(float %unknown) {
; CHECK-LABEL: define nofpclass(snan) float @unknown__maximum__pinf_or_nan(
; CHECK-SAME: float [[UNKNOWN:%.*]]) {
; CHECK-NEXT:    [[PINF_OR_NAN:%.*]] = call float @returns_pinf_or_nan()
; CHECK-NEXT:    [[RESULT:%.*]] = call nsz float @llvm.maximum.f32(float [[UNKNOWN]], float [[PINF_OR_NAN]])
; CHECK-NEXT:    ret float [[RESULT]]
;
  %pinf.or.nan = call float @returns_pinf_or_nan()
  %result = call float @llvm.maximum.f32(float %unknown, float %pinf.or.nan)
  ret float %result
}

define nofpclass(snan) float @ninf__maximum__unknown(float %unknown) {
...
define nofpclass(snan) float @unknown__maximum__ninf(float %unknown) {
...
define nofpclass(snan) float @ninf_or_nan__maximum__unknown(float %unknown) {
; CHECK-LABEL: define nofpclass(snan) float @ninf_or_nan__maximum__unknown(
; CHECK-SAME: float [[UNKNOWN:%.*]]) {
; CHECK-NEXT:    [[NINF_OR_NAN:%.*]] = call float @returns_ninf_or_nan()
; CHECK-NEXT:    [[RESULT:%.*]] = call nsz float @llvm.maximum.f32(float [[NINF_OR_NAN]], float [[UNKNOWN]])
; CHECK-NEXT:    ret float [[RESULT]]
;
  %ninf.or.nan = call float @returns_ninf_or_nan()
  %result = call float @llvm.maximum.f32(float %ninf.or.nan, float %unknown)
  ret float %result
}

define nofpclass(snan) float @unknown__maximum__ninf_or_nan(float %unknown) {
; CHECK-LABEL: define nofpclass(snan) float @unknown__maximum__ninf_or_nan(
; CHECK-SAME: float [[UNKNOWN:%.*]]) {
; CHECK-NEXT:    [[NINF_OR_NAN:%.*]] = call float @returns_ninf_or_nan()
; CHECK-NEXT:    [[RESULT:%.*]] = call nsz float @llvm.maximum.f32(float [[UNKNOWN]], float [[NINF_OR_NAN]])
; CHECK-NEXT:    ret float [[RESULT]]
;
  %ninf.or.nan = call float @returns_ninf_or_nan()
  %result = call float @llvm.maximum.f32(float %unknown, float %ninf.or.nan)
  ret float %result
}

define nofpclass(snan) float @inf__maximum__unknown(float %unknown) {
; CHECK-LABEL: define nofpclass(snan) float @inf__maximum__unknown(
; CHECK-SAME: float [[UNKNOWN:%.*]]) {
; CHECK-NEXT:    [[INF:%.*]] = call float @returns_inf()
; CHECK-NEXT:    [[RESULT:%.*]] = call nsz float @llvm.maximum.f32(float [[INF]], float [[UNKNOWN]])
; CHECK-NEXT:    ret float [[RESULT]]
;
  %inf = call float @returns_inf()
  %result = call float @llvm.maximum.f32(float %inf, float %unknown)
  ret float %result
}

define nofpclass(snan) float @unknown__maximum__inf(float %unknown) {
; CHECK-LABEL: define nofpclass(snan) float @unknown__maximum__inf(
; CHECK-SAME: float [[UNKNOWN:%.*]]) {
; CHECK-NEXT:    [[INF:%.*]] = call float @returns_inf()
...
;
  %inf = call float @returns_inf()
  %result = call float @llvm.maximum.f32(float %unknown, float %inf)
  ret float %result
}

define nofpclass(snan) float @inf_or_nan__maximum__unknown(float %unknown) {
; CHECK-LABEL: define nofpclass(snan) float @inf_or_nan__maximum__unknown(
; CHECK-SAME: float [[UNKNOWN:%.*]]) {
; CHECK-NEXT:    [[INF_OR_NAN:%.*]] = call float @returns_inf_or_nan()
; CHECK-NEXT:    [[RESULT:%.*]] = call nsz float @llvm.maximum.f32(float [[INF_OR_NAN]], float [[UNKNOWN]])
; CHECK-NEXT:    ret float [[RESULT]]
;
  %inf.or.nan = call float @returns_inf_or_nan()
  %result = call float @llvm.maximum.f32(float %inf.or.nan, float %unknown)
  ret float %result
}

define nofpclass(snan) float @unknown__maximum__inf_or_nan(float %unknown) {
; CHECK-LABEL: define nofpclass(snan) float @unknown__maximum__inf_or_nan(
; CHECK-SAME: float [[UNKNOWN:%.*]]) {
; CHECK-NEXT:    [[INF_OR_NAN:%.*]] = call float @returns_inf_or_nan()
; CHECK-NEXT:    [[RESULT:%.*]] = call nsz float @llvm.maximum.f32(float [[UNKNOWN]], float [[INF_OR_NAN]])
; CHECK-NEXT:    ret float [[RESULT]]
;
  %inf.or.nan = call float @returns_inf_or_nan()
  %result = call float @llvm.maximum.f32(float %unknown, float %inf.or.nan)
  ret float %result
}

define nofpclass(snan) float @ninf_or_nan__maximum__not_nan(float nofpclass(nan) %not.nan) {
; CHECK-LABEL: define nofpclass(snan) float @ninf_or_nan__maximum__not_nan(
; CHECK-SAME: float nofpclass(nan) [[NOT_NAN:%.*]]) {
; CHECK-NEXT:    [[NINF_OR_NAN:%.*]] = call float @returns_ninf_or_nan()
; CHECK-NEXT:    [[RESULT:%.*]] = call nsz float @llvm.maximum.f32(float [[NINF_OR_NAN]], float [[NOT_NAN]])
; CHECK-NEXT:    ret float [[RESULT]]
;
  %ninf.or.nan = call float @returns_ninf_or_nan()
...
define nofpclass(snan) float @not_nan__maximum__ninf_or_nan(float nofpclass(nan) %not.nan) {
; CHECK-LABEL: define nofpclass(snan) float @not_nan__maximum__ninf_or_nan(
; CHECK-SAME: float nofpclass(nan) [[NOT_NAN:%.*]]) {
; CHECK-NEXT:    [[NINF_OR_NAN:%.*]] = call float @returns_ninf_or_nan()
; CHECK-NEXT:    [[RESULT:%.*]] = call nsz float @llvm.maximum.f32(float [[NOT_NAN]], float [[NINF_OR_NAN]])
; CHECK-NEXT:    ret float [[RESULT]]
;
  %ninf.or.nan = call float @returns_ninf_or_nan()
...
define nofpclass(snan) float @pinf_or_nan__maximum__not_nan(float nofpclass(nan) %not.nan) {
...
define nofpclass(snan) float @not_nan__maximum__pinf_or_nan(float nofpclass(nan) %not.nan) {
...
define nofpclass(snan) float @inf_or_nan__maximum__not_nan(float nofpclass(nan) %not.nan) {
; CHECK-LABEL: define nofpclass(snan) float @inf_or_nan__maximum__not_nan(
; CHECK-SAME: float nofpclass(nan) [[NOT_NAN:%.*]]) {
; CHECK-NEXT:    [[INF_OR_NAN:%.*]] = call float @returns_inf_or_nan()
; CHECK-NEXT:    [[RESULT:%.*]] = call nsz float @llvm.maximum.f32(float [[INF_OR_NAN]], float [[NOT_NAN]])
; CHECK-NEXT:    ret float [[RESULT]]
;
  %inf.or.nan = call float @returns_inf_or_nan()
  %result = call float @llvm.maximum.f32(float %inf.or.nan, float %not.nan)
  ret float %result
}

define nofpclass(snan) float @not_nan__maximum__inf_or_nan(float nofpclass(nan) %not.nan) {
; CHECK-LABEL: define nofpclass(snan) float @not_nan__maximum__inf_or_nan(
; CHECK-SAME: float nofpclass(nan) [[NOT_NAN:%.*]]) {
; CHECK-NEXT:    [[INF_OR_NAN:%.*]] = call float @returns_inf_or_nan()
; CHECK-NEXT:    [[RESULT:%.*]] = call nsz float @llvm.maximum.f32(float [[NOT_NAN]], float [[INF_OR_NAN]])
; CHECK-NEXT:    ret float [[RESULT]]
;
  %inf.or.nan = call float @returns_inf_or_nan()
  %result = call float @llvm.maximum.f32(float %not.nan, float %inf.or.nan)
  ret float %result
}

define nofpclass(snan) float @ninf__maximum__not_nan(float nofpclass(nan) %not.nan) {
...
define nofpclass(snan) float @not_nan__maximum__ninf(float nofpclass(nan) %not.nan) {
...
define nofpclass(snan) float @pinf__maximum__not_nan(float nofpclass(nan) %not.nan) {
...
define nofpclass(snan) float @not_nan__maximum__pinf(float nofpclass(nan) %not.nan) {
...
define nofpclass(snan) float @inf__maximum__not_nan(float nofpclass(nan) %not.nan) {
; CHECK-LABEL: define nofpclass(snan) float @inf__maximum__not_nan(
; CHECK-SAME: float nofpclass(nan) [[NOT_NAN:%.*]]) {
; CHECK-NEXT:    [[INF_OR_NAN:%.*]] = call float @returns_inf()
; CHECK-NEXT:    [[RESULT:%.*]] = call nnan nsz float @llvm.maximum.f32(float [[INF_OR_NAN]], float [[NOT_NAN]])
; CHECK-NEXT:    ret float [[RESULT]]
;
...
define nofpclass(snan) float @not_nan__maximum__inf(float nofpclass(nan) %not.nan) {
; CHECK-LABEL: define nofpclass(snan) float @not_nan__maximum__inf(
; CHECK-SAME: float nofpclass(nan) [[NOT_NAN:%.*]]) {
; CHECK-NEXT:    [[INF_OR_NAN:%.*]] = call float @returns_inf()
; CHECK-NEXT:    [[RESULT:%.*]] = call nnan nsz float @llvm.maximum.f32(float [[NOT_NAN]], float [[INF_OR_NAN]])
; CHECK-NEXT:    ret float [[RESULT]]
;
  %inf.or.nan = call float @returns_inf()
  %result = call float @llvm.maximum.f32(float %not.nan, float %inf.or.nan)
...
define nofpclass(snan) float @not_nan__noundef_maximum__unknown(float nofpclass(nan) %not.nan, float %unknown) {
; CHECK-LABEL: define nofpclass(snan) float @not_nan__noundef_maximum__unknown(
; CHECK-SAME: float nofpclass(nan) [[NOT_NAN:%.*]], float [[UNKNOWN:%.*]]) {
; CHECK-NEXT:    [[RESULT:%.*]] = call noundef float @llvm.maximum.f32(float [[NOT_NAN]], float [[UNKNOWN]])
; CHECK-NEXT:    ret float [[RESULT]]
;
  %result = call noundef float @llvm.maximum.f32(float %not.nan, float %unknown)
  ret float %result
}

define nofpclass(snan) float @unknown__noundef_maximum__not_nan(float %unknown, float nofpclass(nan) %not.nan) {
; CHECK-LABEL: define nofpclass(snan) float @unknown__noundef_maximum__not_nan(
; CHECK-SAME: float [[UNKNOWN:%.*]], float nofpclass(nan) [[NOT_NAN:%.*]]) {
; CHECK-NEXT:    [[RESULT:%.*]] = call noundef float @llvm.maximum.f32(float [[UNKNOWN]], float [[NOT_NAN]])
; CHECK-NEXT:    ret float [[RESULT]]
;
  %result = call noundef float @llvm.maximum.f32(float %unknown, float %not.nan)
  ret float %result
}
...
define nofpclass(snan) float @not_inf__noundef_maximum__unknown(float nofpclass(inf) %not.inf, float %unknown) {
; CHECK-LABEL: define nofpclass(snan) float @not_inf__noundef_maximum__unknown(
; CHECK-SAME: float nofpclass(inf) [[NOT_INF:%.*]], float [[UNKNOWN:%.*]]) {
; CHECK-NEXT:    [[RESULT:%.*]] = call noundef float @llvm.maximum.f32(float [[NOT_INF]], float [[UNKNOWN]])
; CHECK-NEXT:    ret float [[RESULT]]
;
  %result = call noundef float @llvm.maximum.f32(float %not.inf, float %unknown)
  ret float %result
}

define nofpclass(snan) float @unknown__noundef_maximum__not_inf(float %unknown, float nofpclass(inf) %not.inf) {
; CHECK-LABEL: define nofpclass(snan) float @unknown__noundef_maximum__not_inf(
; CHECK-SAME: float [[UNKNOWN:%.*]], float nofpclass(inf) [[NOT_INF:%.*]]) {
; CHECK-NEXT:    [[RESULT:%.*]] = call noundef float @llvm.maximum.f32(float [[UNKNOWN]], float [[NOT_INF]])
; CHECK-NEXT:    ret float [[RESULT]]
;
  %result = call noundef float @llvm.maximum.f32(float %unknown, float %not.inf)
  ret float %result
}

define nofpclass(snan) float @not_snan__noundef_maximum__not_inf(float nofpclass(inf) %not.inf0, float nofpclass(inf) %not.inf1) {
; CHECK-LABEL: define nofpclass(snan) float @not_snan__noundef_maximum__not_inf(
; CHECK-SAME: float nofpclass(inf) [[NOT_INF0:%.*]], float nofpclass(inf) [[NOT_INF1:%.*]]) {
; CHECK-NEXT:    [[RESULT:%.*]] = call noundef float @llvm.maximum.f32(float [[NOT_INF0]], float [[NOT_INF1]])
; CHECK-NEXT:    ret float [[RESULT]]
;
  %result = call noundef float @llvm.maximum.f32(float %not.inf0, float %not.inf1)
  ret float %result
}
...
define nofpclass(inf) float @not_inf__noundef_maximum__not_inf(float nofpclass(inf) %not.inf0, float nofpclass(inf) %not.inf1) {
; CHECK-LABEL: define nofpclass(inf) float @not_inf__noundef_maximum__not_inf(
; CHECK-SAME: float nofpclass(inf) [[NOT_INF0:%.*]], float nofpclass(inf) [[NOT_INF1:%.*]]) {
; CHECK-NEXT:    [[RESULT:%.*]] = call noundef float @llvm.maximum.f32(float [[NOT_INF0]], float [[NOT_INF1]])
; CHECK-NEXT:    ret float [[RESULT]]
;
...
; CHECK-NEXT:    [[RESULT:%.*]] = call nsz float @llvm.maximum.f32(float [[SELECT]], float [[NNORM_OR_NAN]])
; CHECK-NEXT:    ret float [[RESULT]]
;
  %is.pos.or.zero = fcmp oge float %arg, 0.0
  %select = select i1 %is.pos.or.zero, float %arg, float 0.0
...
; CHECK-NEXT:    [[IS_POS_OR_ZERO:%.*]] = fcmp oge float [[ARG]], 0.000000e+00
; CHECK-NEXT:    [[SELECT:%.*]] = select i1 [[IS_POS_OR_ZERO]], float [[ARG]], float 0.000000e+00
; CHECK-NEXT:    [[RESULT:%.*]] = call nsz float @llvm.maximum.f32(float [[NNORM_OR_NAN]], float [[SELECT]])
; CHECK-NEXT:    ret float [[RESULT]]
;
  %nnorm.or.nan = call float @returns_nnorm_or_nan()
  %is.pos.or.zero = fcmp oge float %arg, 0.0
...
; CHECK-NEXT:    [[RESULT:%.*]] = call nsz float @llvm.maximum.f32(float [[POS_NONZERO]], float [[NEGATIVE_OR_NAN]])
; CHECK-NEXT:    ret float [[RESULT]]
;
  %pos.nonzero = call float @returns_positive_nonzero()
...
; CHECK-NEXT:    [[NEGATIVE_OR_NAN:%.*]] = call float @returns_negative_or_nan()
; CHECK-NEXT:    [[POS_NONZERO:%.*]] = call float @returns_positive_nonzero()
; CHECK-NEXT:    [[RESULT:%.*]] = call nsz float @llvm.maximum.f32(float [[NEGATIVE_OR_NAN]], float [[POS_NONZERO]])
; CHECK-NEXT:    ret float [[RESULT]]
;
  %negative.or.nan = call float @returns_negative_or_nan()
  %pos.nonzero = call float @returns_positive_nonzero()
...
; CHECK-NEXT:    [[POSITIVE:%.*]] = call float @returns_positive()
; CHECK-NEXT:    [[NEGATIVE:%.*]] = call float @returns_negative()
; CHECK-NEXT:    [[MAX:%.*]] = call float @llvm.maximum.f32(float [[POSITIVE]], float [[NEGATIVE]])
; CHECK-NEXT:    store float [[MAX]], ptr [[PTR]], align 4
; CHECK-NEXT:    ret float [[POSITIVE]]
;
  %positive = call float @returns_positive()
  %negative = call float @returns_negative()
  %max = call float @llvm.maximum.f32(float %positive, float %negative)
  store float %max, ptr %ptr
  ret float %max
}

define nofpclass(snan) float @simplify_multiple_use_maximum_commute(ptr %ptr) {
; CHECK-LABEL: define nofpclass(snan) float @simplify_multiple_use_maximum_commute(
; CHECK-SAME: ptr [[PTR:%.*]]) {
; CHECK-NEXT:    [[POSITIVE:%.*]] = call float @returns_positive()
; CHECK-NEXT:    [[NEGATIVE:%.*]] = call float @returns_negative()
; CHECK-NEXT:    [[MAX:%.*]] = call float @llvm.maximum.f32(float [[NEGATIVE]], float [[POSITIVE]])
; CHECK-NEXT:    store float [[MAX]], ptr [[PTR]], align 4
; CHECK-NEXT:    ret float [[POSITIVE]]
;
  %positive = call float @returns_positive()
  %negative = call float @returns_negative()
  %max = call float @llvm.maximum.f32(float %negative, float %positive)
  store float %max, ptr %ptr
  ret float %max
}
...
; CHECK-NEXT:    [[MUST_BE_POSITIVE_OR_ZERO:%.*]] = call float @returns_positive_or_zero()
; CHECK-NEXT:    [[MUST_BE_NEGATIVE_OR_ZERO:%.*]] = call float @returns_negative_or_zero()
; CHECK-NEXT:    [[RESULT:%.*]] = call nsz float @llvm.maximum.f32(float [[MUST_BE_POSITIVE_OR_ZERO]], float [[MUST_BE_NEGATIVE_OR_ZERO]])
; CHECK-NEXT:    store float [[RESULT]], ptr [[PTR]], align 4
; CHECK-NEXT:    ret float [[MUST_BE_POSITIVE_OR_ZERO]]
;
  %must.be.positive.or.zero = call float @returns_positive_or_zero()
