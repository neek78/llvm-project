...
; CHECK-SAME: float [[X:%.*]], float [[Y:%.*]]) {
; CHECK-NEXT:    [[RESULT:%.*]] = call nnan nsz float @llvm.minimum.f32(float [[X]], float [[Y]])
; CHECK-NEXT:    ret float [[RESULT]]
;
  %result = call float @llvm.minimum.f32(float %x, float %y)
  ret float %result
...
; CHECK-NEXT:    [[RESULT:%.*]] = call nsz float @llvm.minimum.f32(float [[MUST_BE_PINF_OR_NAN]], float [[UNKNOWN]])
; CHECK-NEXT:    ret float [[RESULT]]
;
...
; CHECK-NEXT:    [[RESULT:%.*]] = call nsz float @llvm.minimum.f32(float [[UNKNOWN]], float [[MUST_BE_PINF_OR_NAN]])
; CHECK-NEXT:    ret float [[RESULT]]
;
...
; CHECK-NEXT:    [[RESULT:%.*]] = call nsz float @llvm.minimum.f32(float [[MUST_BE_NINF_OR_NAN]], float [[UNKNOWN]])
; CHECK-NEXT:    ret float [[RESULT]]
;
...
; CHECK-NEXT:    [[RESULT:%.*]] = call nsz float @llvm.minimum.f32(float [[UNKNOWN]], float [[MUST_BE_NINF_OR_NAN]])
; CHECK-NEXT:    ret float [[RESULT]]
;
...
; CHECK-SAME: float [[UNKNOWN0:%.*]], float [[UNKNOWN1:%.*]]) {
; CHECK-NEXT:    [[RESULT:%.*]] = call nsz float @llvm.minimum.f32(float [[UNKNOWN0]], float [[UNKNOWN1]])
; CHECK-NEXT:    ret float [[RESULT]]
;
  %result = call float @llvm.minimum.f32(float %unknown0, float %unknown1)
  ret float %result
...
; CHECK-NEXT:    [[RESULT:%.*]] = call nsz float @llvm.minimum.f32(float [[NOT_ZERO]], float [[UNKNOWN]])
; CHECK-NEXT:    ret float [[RESULT]]
;
...
; CHECK-NEXT:    [[RESULT:%.*]] = call nsz float @llvm.minimum.f32(float [[UNKNOWN]], float [[NOT_ZERO]])
; CHECK-NEXT:    ret float [[RESULT]]
;
...
; CHECK-NEXT:    [[RESULT:%.*]] = call nsz float @llvm.minimum.f32(float [[NOT_ZERO0]], float [[NOT_ZERO1]])
; CHECK-NEXT:    ret float [[RESULT]]
;
...
; CHECK-NEXT:    [[RESULT:%.*]] = call nsz float @llvm.minimum.f32(float [[NOT_ZERO_SUB_0]], float [[NOT_ZERO_SUB_1]])
; CHECK-NEXT:    ret float [[RESULT]]
;
...
; CHECK-NEXT:    [[RESULT:%.*]] = call nsz float @llvm.minimum.f32(float [[NOT_NZERO0]], float [[NOT_NZERO1]])
; CHECK-NEXT:    ret float [[RESULT]]
;
...
; CHECK-NEXT:    [[RESULT:%.*]] = call nsz float @llvm.minimum.f32(float [[NOT_PZERO0]], float [[NOT_PZERO1]])
; CHECK-NEXT:    ret float [[RESULT]]
;
...
; CHECK-NEXT:    [[RESULT:%.*]] = call nsz float @llvm.minimum.f32(float [[KNOWN_NEGATIVE]], float [[KNOWN_NZERO_OR_NAN]])
; CHECK-NEXT:    ret float [[RESULT]]
;
  %known.negative = call float @returns_negative()
...
; CHECK-NEXT:    [[KNOWN_NZERO_OR_NAN:%.*]] = call float @returns_nzero_or_nan()
; CHECK-NEXT:    [[KNOWN_NEGATIVE:%.*]] = call float @returns_negative()
; CHECK-NEXT:    [[RESULT:%.*]] = call nsz float @llvm.minimum.f32(float [[KNOWN_NZERO_OR_NAN]], float [[KNOWN_NEGATIVE]])
; CHECK-NEXT:    ret float [[RESULT]]
;
  %known.nzero.or.nan = call float @returns_nzero_or_nan()
  %known.negative = call float @returns_negative()
...
; CHECK-NEXT:    [[RESULT:%.*]] = call nsz float @llvm.minimum.f32(float [[NOT_ZERO]], float [[SELECT_RHS]])
; CHECK-NEXT:    ret float [[RESULT]]
;
  %always.positive = call float @returns_positive()
...
; CHECK-NEXT:    [[RESULT:%.*]] = call nsz float @llvm.minimum.f32(float [[PINF_OR_NAN]], float [[UNKNOWN]])
; CHECK-NEXT:    ret float [[RESULT]]
;
...
; CHECK-SAME: float [[UNKNOWN:%.*]]) {
; CHECK-NEXT:    [[PINF_OR_NAN:%.*]] = call float @returns_pinf_or_nan()
; CHECK-NEXT:    [[RESULT:%.*]] = call nsz float @llvm.minimum.f32(float [[UNKNOWN]], float [[PINF_OR_NAN]])
; CHECK-NEXT:    ret float [[RESULT]]
;
  %pinf.or.nan = call float @returns_pinf_or_nan()
...
; CHECK-NEXT:    [[RESULT:%.*]] = call nsz float @llvm.minimum.f32(float [[NINF_OR_NAN]], float [[UNKNOWN]])
; CHECK-NEXT:    ret float [[RESULT]]
;
...
; CHECK-SAME: float [[UNKNOWN:%.*]]) {
; CHECK-NEXT:    [[NINF_OR_NAN:%.*]] = call float @returns_ninf_or_nan()
; CHECK-NEXT:    [[RESULT:%.*]] = call nsz float @llvm.minimum.f32(float [[UNKNOWN]], float [[NINF_OR_NAN]])
; CHECK-NEXT:    ret float [[RESULT]]
;
  %ninf.or.nan = call float @returns_ninf_or_nan()
...
; CHECK-NEXT:    [[RESULT:%.*]] = call nsz float @llvm.minimum.f32(float [[INF]], float [[UNKNOWN]])
; CHECK-NEXT:    ret float [[RESULT]]
;
...
; CHECK-NEXT:    [[RESULT:%.*]] = call nsz float @llvm.minimum.f32(float [[INF_OR_NAN]], float [[UNKNOWN]])
; CHECK-NEXT:    ret float [[RESULT]]
;
...
; CHECK-SAME: float [[UNKNOWN:%.*]]) {
; CHECK-NEXT:    [[INF_OR_NAN:%.*]] = call float @returns_inf_or_nan()
; CHECK-NEXT:    [[RESULT:%.*]] = call nsz float @llvm.minimum.f32(float [[UNKNOWN]], float [[INF_OR_NAN]])
; CHECK-NEXT:    ret float [[RESULT]]
;
  %inf.or.nan = call float @returns_inf_or_nan()
...
; CHECK-SAME: float nofpclass(nan) [[NOT_NAN:%.*]]) {
; CHECK-NEXT:    [[PINF_OR_NAN:%.*]] = call float @returns_pinf_or_nan()
; CHECK-NEXT:    [[RESULT:%.*]] = call nsz float @llvm.minimum.f32(float [[PINF_OR_NAN]], float [[NOT_NAN]])
; CHECK-NEXT:    ret float [[RESULT]]
;
  %pinf.or.nan = call float @returns_pinf_or_nan()
...
; CHECK-SAME: float nofpclass(nan) [[NOT_NAN:%.*]]) {
; CHECK-NEXT:    [[PINF_OR_NAN:%.*]] = call float @returns_pinf_or_nan()
; CHECK-NEXT:    [[RESULT:%.*]] = call nsz float @llvm.minimum.f32(float [[NOT_NAN]], float [[PINF_OR_NAN]])
; CHECK-NEXT:    ret float [[RESULT]]
;
  %pinf.or.nan = call float @returns_pinf_or_nan()
...
; CHECK-SAME: float nofpclass(nan) [[NOT_NAN:%.*]]) {
; CHECK-NEXT:    [[INF_OR_NAN:%.*]] = call float @returns_inf_or_nan()
; CHECK-NEXT:    [[RESULT:%.*]] = call nsz float @llvm.minimum.f32(float [[INF_OR_NAN]], float [[NOT_NAN]])
; CHECK-NEXT:    ret float [[RESULT]]
;
  %inf.or.nan = call float @returns_inf_or_nan()
...
; CHECK-SAME: float nofpclass(nan) [[NOT_NAN:%.*]]) {
; CHECK-NEXT:    [[INF_OR_NAN:%.*]] = call float @returns_inf_or_nan()
; CHECK-NEXT:    [[RESULT:%.*]] = call nsz float @llvm.minimum.f32(float [[NOT_NAN]], float [[INF_OR_NAN]])
; CHECK-NEXT:    ret float [[RESULT]]
;
  %inf.or.nan = call float @returns_inf_or_nan()
...
; CHECK-NEXT:    [[RESULT:%.*]] = call nnan nsz float @llvm.minimum.f32(float [[INF_OR_NAN]], float [[NOT_NAN]])
; CHECK-NEXT:    ret float [[RESULT]]
;
...
; CHECK-SAME: float nofpclass(nan) [[NOT_NAN:%.*]]) {
; CHECK-NEXT:    [[INF_OR_NAN:%.*]] = call float @returns_inf()
; CHECK-NEXT:    [[RESULT:%.*]] = call nnan nsz float @llvm.minimum.f32(float [[NOT_NAN]], float [[INF_OR_NAN]])
; CHECK-NEXT:    ret float [[RESULT]]
;
  %inf.or.nan = call float @returns_inf()
  %result = call float @llvm.minimum.f32(float %not.nan, float %inf.or.nan)
...
; CHECK-NEXT:    [[NEGATIVE:%.*]] = call float @returns_negative()
; CHECK-NEXT:    [[RESULT:%.*]] = call nsz float @llvm.minimum.f32(float [[POS_NONZERO_OR_NAN]], float [[NEGATIVE]])
; CHECK-NEXT:    ret float [[RESULT]]
;
...
; CHECK-NEXT:    [[NEGATIVE:%.*]] = call float @returns_negative()
; CHECK-NEXT:    [[POS_NONZERO_OR_NAN:%.*]] = call float @returns_positive_nonzero_or_nan()
; CHECK-NEXT:    [[RESULT:%.*]] = call nsz float @llvm.minimum.f32(float [[NEGATIVE]], float [[POS_NONZERO_OR_NAN]])
; CHECK-NEXT:    ret float [[RESULT]]
;
  %negative = call float @returns_negative()
  %pos.nonzero.or.nan = call float @returns_positive_nonzero_or_nan()
...
; CHECK-NEXT:    [[POSITIVE:%.*]] = call float @returns_positive()
; CHECK-NEXT:    [[NEGATIVE:%.*]] = call float @returns_negative()
; CHECK-NEXT:    [[MIN:%.*]] = call float @llvm.minimum.f32(float [[POSITIVE]], float [[NEGATIVE]])
; CHECK-NEXT:    store float [[MIN]], ptr [[PTR]], align 4
; CHECK-NEXT:    ret float [[NEGATIVE]]
;
  %positive = call float @returns_positive()
  %negative = call float @returns_negative()
  %min = call float @llvm.minimum.f32(float %positive, float %negative)
  store float %min, ptr %ptr
  ret float %min
}

define nofpclass(snan) float @simplify_multiple_use_minimum_commute(ptr %ptr) {
; CHECK-LABEL: define nofpclass(snan) float @simplify_multiple_use_minimum_commute(
; CHECK-SAME: ptr [[PTR:%.*]]) {
; CHECK-NEXT:    [[POSITIVE:%.*]] = call float @returns_positive()
; CHECK-NEXT:    [[NEGATIVE:%.*]] = call float @returns_negative()
; CHECK-NEXT:    [[MIN:%.*]] = call float @llvm.minimum.f32(float [[NEGATIVE]], float [[POSITIVE]])
; CHECK-NEXT:    store float [[MIN]], ptr [[PTR]], align 4
; CHECK-NEXT:    ret float [[NEGATIVE]]
;
  %positive = call float @returns_positive()
  %negative = call float @returns_negative()
  %min = call float @llvm.minimum.f32(float %negative, float %positive)
  store float %min, ptr %ptr
  ret float %min
}
